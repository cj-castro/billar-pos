      ...
      <div className="max-w-2xl mx-auto p-4">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="bg-zinc-800 rounded-xl p-4 text-center">
            ...
            <div className="text-xs text-zinc-400 mt-1">Total Colectado</div>
          </div>
          <div className="bg-zinc-800 rounded-xl p-4 text-center">
            <div className="text-2xl font-bold text-zinc-200">{(collections as any[]).length}</div>
            <div className="text-xs text-zinc-400 mt-1">Registros</div>
          </div>
        </div>
        ...
        <div className="bg-zinc-800 rounded-2xl p-5 border border-emerald-800 mb-6">
          ...
          <input
            ...
            className="w-full bg-zinc-700 border border-zinc-600 rounded-lg px-3 py-2 text-sm mb-3"
          />
          <button
            onClick={handleAdd}
            disabled={saving}
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {(collections as any[]).map((r: any) => (
                  <tr key={r.id} className="border-t border-zinc-700 hover:bg-zinc-700/30">
                    ...
                    <td className="p-3">
                      ...
                      <div className="text-xs text-zinc-500">@{r.collector_username}</div>
                    </td>
